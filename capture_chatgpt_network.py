...
Usage:
  sudo python3 capture_chatgpt_network.py --interface en0 --outfile ~/Desktop/chatgpt_filtered.pcap
...
def main():
    ...
    print(f"[i] Resolving hosts: {hosts}")
    ...
    try:
        ...
        # 1) TLS SNI or DNS containing "chatgpt"
        sni_dns_filter = 'tls.handshake.extensions_server_name contains "chatgpt" or dns.qry.name contains "chatgpt"'

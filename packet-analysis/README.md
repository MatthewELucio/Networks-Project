...
**Input**: `flowlet_features.json` (generated by `../data-pipeline/flowlet-parsing/parse_flowlets_encrypted.py --extract-features`)
...
**Why These Work**:
- LLM services stream responses → larger packets
...
- Main parsing script: `../data-pipeline/flowlet-parsing/parse_flowlets_encrypted.py`

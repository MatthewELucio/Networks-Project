...
**Input**: `flowlet_features.json` (generated by `../data-pipeline/parsing/parse_flowlets_encrypted.py --extract-features`)
...
- Main parsing script: `../data-pipeline/parsing/parse_flowlets_encrypted.py`

...
**Input**: `flowlet_features.json` (generated by `../data-pipeline/parse_flowlets_encrypted.py --extract-features`)
...
- Main parsing script: `../data-pipeline/parse_flowlets_encrypted.py`
